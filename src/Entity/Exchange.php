...
class Exchange
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=StockPrice::class, mappedBy="exchange", orphanRemoval=true)
     */
    private $stockPrices;
    ...
    public function removeStockPrice(StockPrice $stockPrice): self
    {
        if ($this->stockPrices->removeElement($stockPrice)) {
            ...
            if ($stockPrice->getExchange() === $this) {
                $stockPrice->setExchange(null);
            }
        }
